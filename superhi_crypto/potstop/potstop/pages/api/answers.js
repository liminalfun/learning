...
export default function handler(req, res) {
  ...
  if (req.method === "POST") {
    ...
    const data = [
      { questionId: 1, answerId: 1, reply: answers[0], account: "0xc32659651d137a18b79925449722855aa327231d" },
      { questionId: 1, answerId: 2, reply: answers[1], account: "0xf854979558c3509d95BB4b8BF519b2c5EE9d5a7a" },
      { questionId: 1, answerId: 3, reply: answers[2], account: "0xb25bf3990c5a274a758a2a3a4cc90b3e407eaaf4" }
    ]
