...
export default function Home() {
  ...
  const [accounts, setAccounts] = useState([]) // set default to empty array as fallback (so it's not undefined, and we can evaluate conditional logic using array methods, such as .length)
  ...
  // runs whenever accounts updates
  useEffect(function () {
  ...
  let answersArea = (
    <div className="loading">Loading {answers.length} answers...</div>
  )
